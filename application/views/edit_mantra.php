        ...
        <div class="card p-4">
          <div class="card-body">
            ...
            ?>
		        ...
		        <?php echo form_open_multipart('Medias/edit_mantra/'.$data['mantra_id']); ?>
            ...
            <div class="input-group mb-4">
              <?php echo form_upload(['name'=>'mantra_name', 'class' => 'form-control', 'placeholder' => 'Mantra', 'id' => 'mantra_name']); ?>
            </div>
		        <div class="input-group mb-4">
            <?php 
              $status = $data['status'];
            ...
            <div class="row">
              <div class="col-6">
                ...
                <?php echo anchor('Medias/mantras', 'Back', array('title' => 'Back', 'class' => 'btn btn-primary')); ?>
              </div>
            </div>
		        <?php echo form_close(); ?>
          </div>

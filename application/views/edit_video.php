        ...
        <div class="card p-4">
          <div class="card-body">
            ...
            ?>
		        ...
		        <?php echo form_open('Medias/edit_video/'.$data['video_id']); ?>
            <div class="input-group mb-4">
              <?php $title = $data['title']; echo form_input(['name'=>'title', 'class' => 'form-control ' . (empty(form_error('title')) ? "" : "is-invalid"), 'placeholder' => 'Title', 'id' => 'title', 'type' => 'text', 'value' => "$title" ]); ?>
		        ...
		        <div class="input-group mb-4">
              <?php $url = $data['url']; echo form_input(['name'=>'url', 'class' => 'form-control ' . (empty(form_error('url')) ? "" : "is-invalid"), 'placeholder' => 'URL', 'id' => 'url', 'type' => 'text', 'value' => "$url" ]); ?>
            ...
            <div class="row">
              <div class="col-6">
                ...
                <?php echo anchor('Medias/videos', 'Back', array('title' => 'Back', 'class' => 'btn btn-primary')); ?>
              </div>
            </div>
		        <?php echo form_close(); ?>
          </div>

        ...
        <div class="card p-4">
          <div class="card-body">
            ...
            <p style="color:red;">
		        ...
		        <?php echo form_open('Rituals/add_monthly_ritual'); ?>
            <div class="input-group mb-4">
              <?php echo form_input(['name'=>'title', 'class' => 'form-control ' . (empty(form_error('title')) ? "" : "is-invalid"), 'placeholder' => 'Title', 'id' => 'title', 'type' => 'text' ]); ?>
		        ...
		        <div class="input-group mb-4">
              <?php echo form_input(['name'=>'date', 'class' => 'form-control ' . (empty(form_error('date')) ? "" : "is-invalid"), 'placeholder' => 'Date', 'id' => 'date', 'type' => 'date' ]); ?>

        ...
        <div class="card p-4">
          <div class="card-body">
            ...
            <p style="color:red;">
		        ...
		        <?php echo form_open_multipart('Medias/add_photo'); ?>
            ...
            <div class="input-group mb-4">
              ...
              <input type = "file" name = "photo_name" size = "20" /> 
            </div>
            <div class="row">
              <div class="col-6">                    
                <?php echo form_submit(['name'=>'submit', 'class' => 'btn btn-primary px-4', 'value' => 'Submit', 'type' => 'submit' ]); ?>
                <?php echo anchor('Medias/photos', 'Back', array('title' => 'Back', 'class' => 'btn btn-primary')); ?>
              </div>
            </div>
		        <?php echo form_close(); ?>
          </div>
